...
function theme_integration_wizard( $atts ) {
	...
	if ( is_ic_integration_wizard_page() ) {
		...
		if ( !isset( $_GET[ 'test_advanced' ] ) ) {
			...
			$box_content .= 'jQuery("input[name=\"disable_price\"]").change(function() { if (jQuery(this).is(":checked")) { jQuery("table.price-table, .price-container").hide();} else {jQuery("table.price-table, .price-container").show();}});';
			$box_content .= 'jQuery("input[name=\"disable_sku\"]").change(function() { if (jQuery(this).is(":checked")) { jQuery("table.sku-table").hide();} else {jQuery("table.sku-table").show();}});';
			$box_content .= 'jQuery("input[name=\"disable_shipping\"]").change(function() { if (jQuery(this).is(":checked")) { jQuery("table.shipping-table, .shipping-table-container").hide();} else {jQuery("table.shipping-table, .shipping-table-container").show();}});';
			$box_content .= 'jQuery("input[name=\"disable_attributes\"]").change(function() { if (jQuery(this).is(":checked")) { jQuery(".plain #product_features, .boxed h3[data-tab_id=\'product_features\']").hide(); jQuery(".boxed h3[data-tab_id=\'product_description\']").click();} else {jQuery(".plain #product_features, .boxed h3[data-tab_id=\'product_features\']").show();}});';
